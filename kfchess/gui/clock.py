...
from kfchess.gui.config import BOARD_X_OFFSET_PX, BOARD_SIZE_PX
...
class Clock:
    ...
    def draw(self, canvas):
        ...
        x = BOARD_X_OFFSET_PX + _board_width // 2 - 30
        canvas.put_text(text, x, board_height + 30, 0.8, color=CLOCK_COLOR)
